...
export class AlternativeGeneratorService {

  constructor() { }

  public generateVariations(originalCode: string, count: number): string[] {
    const entries = [];
    for (let i = 0; i < count; i++) {
      ...
      entries.push(generator.generate(this.mutateAst(ast)));
    }
